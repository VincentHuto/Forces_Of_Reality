...
public class ModelHasturClone extends PlayerModel<EntityHasturClone> {

	public ModelHasturClone() {
		super(0.3f, false);
		textureWidth = 64;
		textureHeight = 64;
	...
	@Override
	public void setRotationAngles(EntityHasturClone entity, float limbSwing, float limbSwingAmount, float ageInTicks,
