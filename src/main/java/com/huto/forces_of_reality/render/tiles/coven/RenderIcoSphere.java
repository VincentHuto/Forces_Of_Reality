...
import com.huto.forces_of_reality.init.RenderTypeInit;
import com.huto.forces_of_reality.models.block.ObjModelHandler;
...
public class RenderIcoSphere extends TileEntityRenderer<TileEntityIcoSphere> {
	public static final NonNullLazy<ObjModelHandler> modelSphere = NonNullLazy
			.of(() -> ObjModelHandler.of("forces_of_reality:models/block/sphere.obj"));
	public static final NonNullLazy<ObjModelHandler> modelSphereInside = NonNullLazy
			.of(() -> ObjModelHandler.of("forces_of_reality:models/block/sphere_inside.obj"));

	public static final NonNullLazy<ObjModelHandler> modelTorus = NonNullLazy
			.of(() -> ObjModelHandler.of("forces_of_reality:models/block/torus.obj"));

	public static final NonNullLazy<ObjModelHandler> modelHexTorus = NonNullLazy
			.of(() -> ObjModelHandler.of("forces_of_reality:models/block/hextorus.obj"));
