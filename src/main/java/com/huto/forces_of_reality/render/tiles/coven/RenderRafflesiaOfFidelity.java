package com.huto.forces_of_reality.render.tiles.coven;

import com.huto.forces_of_reality.ForcesOfReality;
import com.huto.forces_of_reality.models.block.ModelDrumMagatama;
...
public class RenderRafflesiaOfFidelity extends TileEntityRenderer<TileEntityRafflesiaOfFidelity> {
	private final ModelDrumMagatama magatamas = new ModelDrumMagatama();

	public RenderRafflesiaOfFidelity(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityRafflesiaOfFidelity te, float partialTicks, MatrixStack matrixStackIn,
		...
		for (int i = 1; i < te.getLevel(); i++) {
			...
			IVertexBuilder ivertexbuilder = irendertypebuffer$impl.getBuffer(magatamas.getRenderType(
					new ResourceLocation(ForcesOfReality.MOD_ID + ":textures/blocks/end_portal_red.png")));
