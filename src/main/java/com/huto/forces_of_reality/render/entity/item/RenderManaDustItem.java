package com.huto.forces_of_reality.render.entity.item;
...
public class RenderManaDustItem extends EntityRenderer<ItemEntity> {
	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;
	private final Random random = new Random();

	public RenderManaDustItem(EntityRendererManager renderManagerIn) {
