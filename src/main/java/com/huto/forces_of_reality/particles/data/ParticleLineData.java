...
import com.huto.forces_of_reality.particles.ParticleLine;
...
public class ParticleLineData implements IParticleFactory<ColoredDynamicTypeData> {
    ...
    public static IParticleData createData(ParticleColor color) {
        return new ColoredDynamicTypeData(ParticleInit.line.get(), color, (float) ParticleUtil.inRange(0.05, 0.15), 40+random.nextInt(20));
    }
