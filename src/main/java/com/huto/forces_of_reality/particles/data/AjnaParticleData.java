...
public class AjnaParticleData implements IParticleFactory<ColoredDynamicTypeData> {
    private final IAnimatedSprite spriteSet;
    public static final String NAME = "ajna";

    public static final Random random = new Random();
    public AjnaParticleData(IAnimatedSprite sprite) {
    ...
    public static IParticleData createData(ParticleColor color) {
        return new ColoredDynamicTypeData(ParticleInit.ajna.get(), color,.25f,  36);
    }

    public static IParticleData createData(ParticleColor color, float scale, int age) {
        return new ColoredDynamicTypeData(ParticleInit.ajna.get(), color, scale, age);
    }
