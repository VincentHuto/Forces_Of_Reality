package com.huto.forces_of_reality.entities.passive;
...
public class EntityDenizen extends AnimalEntity {
	...
	public static final Map<Integer, ResourceLocation> TEXTURE_BY_ID = Util.make(Maps.newHashMap(), (p_213410_0_) -> {
		p_213410_0_.put(0, new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_grey.png"));
		p_213410_0_.put(1,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_grey_cloak.png"));
		p_213410_0_.put(2, new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_red.png"));
		p_213410_0_.put(3,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_red_cloak.png"));
		p_213410_0_.put(4, new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_white.png"));
		p_213410_0_.put(5,
