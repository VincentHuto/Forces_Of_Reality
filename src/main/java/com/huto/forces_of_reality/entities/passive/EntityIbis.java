...
public class EntityIbis extends AnimalEntity {
	...
	public static final Map<Integer, ResourceLocation> TEXTURE_BY_ID = Util.make(Maps.newHashMap(), (p_213410_0_) -> {
		p_213410_0_.put(0, new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/ibis/model_ibis_red.png"));
		p_213410_0_.put(1, new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/ibis/model_ibis_grey.png"));
		p_213410_0_.put(2, new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/ibis/model_ibis_brown.png"));
	});
