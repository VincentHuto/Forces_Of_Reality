package com.huto.forces_of_reality.gui.pages.coven;
...
import com.huto.forces_of_reality.gui.pages.GuiUtil;
...
@OnlyIn(Dist.CLIENT)
public class GuiCovenImagePage extends GuiCovenPage {
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		...
		GlStateManager.pushMatrix();
		{
			...
			// drawCenteredString(matrixStack, font, I18n.format(text), 175, 10, 51120);
