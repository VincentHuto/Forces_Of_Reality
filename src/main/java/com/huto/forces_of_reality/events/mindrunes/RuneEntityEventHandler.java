...
import com.huto.forces_of_reality.capabilities.mindrunes.RunesContainer;
import com.huto.forces_of_reality.capabilities.mindrunes.RunesContainerProvider;
...
public class RuneEntityEventHandler {
    ...
    public static void attachCapabilitiesPlayer(AttachCapabilitiesEvent<Entity> event) {
        if (event.getObject() instanceof PlayerEntity) {
            event.addCapability(new ResourceLocation(ForcesOfReality.MOD_ID, "container"), new RunesContainerProvider((PlayerEntity) event.getObject()));
        }
    }
