...
import com.huto.forces_of_reality.recipes.RecipeWandMaker;
...
public class WandMakerRecipeCategory implements IRecipeCategory<RecipeWandMaker> {
	...
	public static final ResourceLocation UID = new ResourceLocation(ForcesOfReality.MOD_ID, "wand_maker");
	...
	public WandMakerRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("forces_of_reality.jei.wandmaker");
		overlay = guiHelper.createDrawable(new ResourceLocation("forces_of_reality", "textures/gui/wand_maker_overlay.png"), 0,
				0, 150, 110);
