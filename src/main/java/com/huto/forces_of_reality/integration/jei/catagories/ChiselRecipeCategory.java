...
import com.huto.forces_of_reality.gui.pages.GuiButtonTextured;
...
public class ChiselRecipeCategory implements IRecipeCategory<RecipeChiselStation> {
	public static final ResourceLocation UID = new ResourceLocation(ForcesOfReality.MOD_ID, "runic_chisel_station");
	...
	public ChiselRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("forces_of_reality.jei.chisel_station");
		overlay = guiHelper.createDrawable(new ResourceLocation("forces_of_reality", "textures/gui/chiseloverlay.png"), 0, 0,
				150, 110);
