...
import com.huto.forces_of_reality.recipes.RecipeAutoInscriber;
...
public class AutoInscriberRecipeCategory implements IRecipeCategory<RecipeAutoInscriber> {
	...
	public static final ResourceLocation UID = new ResourceLocation(ForcesOfReality.MOD_ID, "auto_inscriber");
	...
	public AutoInscriberRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("forces_of_reality.jei.auto_inscriber");
		overlay = guiHelper.createDrawable(new ResourceLocation("forces_of_reality", "textures/gui/auto_inscriber_overlay.png"),
				0, 0, 150, 110);
