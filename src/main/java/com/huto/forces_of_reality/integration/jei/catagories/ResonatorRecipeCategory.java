...
import com.huto.forces_of_reality.objects.tileenties.util.EnumEssecenceType;
import com.huto.forces_of_reality.recipes.RecipeResonator;
...
public class ResonatorRecipeCategory implements IRecipeCategory<RecipeResonator> {
	...
	public ResonatorRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("forces_of_reality.jei.resonator");
