...
import com.huto.forces_of_reality.recipes.RecipeFuser;
...
public class VibeFuserRecipeCategory implements IRecipeCategory<RecipeFuser> {
	...
	public static final ResourceLocation UID = new ResourceLocation(ForcesOfReality.MOD_ID, "vibe_fuser");
	...
	public VibeFuserRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("forces_of_reality.jei.vibefuser");
		overlay = guiHelper.createDrawable(new ResourceLocation("forces_of_reality", "textures/gui/fuseroverlay.png"), 0, 0, 150,
				110);
