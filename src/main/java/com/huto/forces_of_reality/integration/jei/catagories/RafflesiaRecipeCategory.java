...
import com.huto.forces_of_reality.recipes.RecipeRafflesia;
...
public class RafflesiaRecipeCategory implements IRecipeCategory<RecipeRafflesia> {
	...
	public RafflesiaRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("forces_of_reality.jei.rafflesia_of_fidelity");
		overlay = guiHelper.createDrawable(new ResourceLocation("forces_of_reality", "textures/gui/rafflesia_overlay.png"), 0, 0, 150,
				110);
