...
package com.huto.forces_of_reality.integration.jei.catagories;
...
public class HarmonizerRecipeCategory implements IRecipeCategory<RecipeHarmonizer> {
	...
	public static final ResourceLocation UID = new ResourceLocation(ForcesOfReality.MOD_ID, "crystal_harmonizer");
	...
	public HarmonizerRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("forces_of_reality.jei.harmonizer");
		overlay = guiHelper.createDrawable(new ResourceLocation("forces_of_reality", "textures/gui/resonatoroverlay.png"), 0, 0,
				150, 110);
