...
import com.huto.forces_of_reality.ForcesOfReality.HutosModItemGroup;
...
import com.huto.forces_of_reality.objects.items.ItemActualizationNode;
import com.huto.forces_of_reality.objects.items.ItemChannelingIngot;
import com.huto.forces_of_reality.objects.items.ItemCovenTome;
import com.huto.forces_of_reality.objects.items.ItemDryingAgent;
import com.huto.forces_of_reality.objects.items.ItemElderTome;
import com.huto.forces_of_reality.objects.items.ItemGrandPurgingStone;
import com.huto.forces_of_reality.objects.items.ItemHarmonicImprint;
import com.huto.forces_of_reality.objects.items.ItemManaPowder;
import com.huto.forces_of_reality.objects.items.ItemNullIngot;
import com.huto.forces_of_reality.objects.items.ItemSacrificial;
import com.huto.forces_of_reality.objects.items.ItemShatterIngot;
import com.huto.forces_of_reality.objects.items.ItemSlugBucket;
import com.huto.forces_of_reality.objects.items.ItemSoakingAgent;
import com.huto.forces_of_reality.objects.items.ItemSomnolentTome;
import com.huto.forces_of_reality.objects.items.ItemStormingAgent;
import com.huto.forces_of_reality.objects.items.ItemUpgrade;
import com.huto.forces_of_reality.objects.items.ModSpawnEggItem;
...
import com.huto.forces_of_reality.objects.items.armor.ItemInfluenceSuppressor;
import com.huto.forces_of_reality.objects.items.armor.ItemMysteriousMask;
import com.huto.forces_of_reality.objects.items.armor.ItemRepulsionCharm;
import com.huto.forces_of_reality.objects.items.armor.ItemSkullHelmet;
...
import com.huto.forces_of_reality.objects.items.fidelity.ItemWatchfulPendant;
import com.huto.forces_of_reality.objects.items.fidelity.ItemYellowSign;
import com.huto.forces_of_reality.objects.items.runes.ItemContractRune;
import com.huto.forces_of_reality.objects.items.runes.ItemGuidanceRune;
import com.huto.forces_of_reality.objects.items.runes.ItemMilkweedRune;
import com.huto.forces_of_reality.objects.items.runes.ItemRune;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternBeast;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternBeastContract;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternClawmark;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternCommunion;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternCorruptionContract;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternEye;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternGuidance;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternHeir;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternHunterContract;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternImpurityContract;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternLake;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternMetamorphosis;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternMetamorphosisCW;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternMilkWeedContract;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternMoon;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternOedon;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternRadianceContract;
import com.huto.forces_of_reality.objects.items.runes.patterns.ItemRunePatternRapture;
import com.huto.forces_of_reality.objects.items.tools.EnumModToolTiers;
import com.huto.forces_of_reality.objects.items.tools.ItemAllegianceIdentifier;
import com.huto.forces_of_reality.objects.items.tools.ItemBowBlade;
import com.huto.forces_of_reality.objects.items.tools.ItemDebugTool;
import com.huto.forces_of_reality.objects.items.tools.ItemDemonFlute;
import com.huto.forces_of_reality.objects.items.tools.ItemDestructOrb;
import com.huto.forces_of_reality.objects.items.tools.ItemDestructOrbContained;
import com.huto.forces_of_reality.objects.items.tools.ItemDiscordantBell;
import com.huto.forces_of_reality.objects.items.tools.ItemDivineFeather;
import com.huto.forces_of_reality.objects.items.tools.ItemFrequencyMatcher;
import com.huto.forces_of_reality.objects.items.tools.ItemKnapper;
import com.huto.forces_of_reality.objects.items.tools.ItemMachinaCage;
import com.huto.forces_of_reality.objects.items.tools.ItemMakerActivator;
import com.huto.forces_of_reality.objects.items.tools.ItemManaExtractor;
import com.huto.forces_of_reality.objects.items.tools.ItemMechanGlove;
import com.huto.forces_of_reality.objects.items.tools.ItemMechanModuleBase;
import com.huto.forces_of_reality.objects.items.tools.ItemResonanceDestabalizer;
import com.huto.forces_of_reality.objects.items.tools.ItemRuneBinder;
import com.huto.forces_of_reality.objects.items.tools.ItemSelfAnalyzer;
import com.huto.forces_of_reality.objects.items.tools.ItemSelfReflectionMirror;
import com.huto.forces_of_reality.objects.items.tools.ItemStarSlug;
import com.huto.forces_of_reality.objects.items.tools.ItemTrickAxe;
import com.huto.forces_of_reality.objects.items.tools.ItemWandConsumeVibes;
import com.huto.forces_of_reality.objects.items.tools.ItemWandGainVibes;
import com.huto.forces_of_reality.objects.items.tools.ItemYellowTome;
import com.huto.forces_of_reality.objects.items.tools.ToolVeinPickaxe;
