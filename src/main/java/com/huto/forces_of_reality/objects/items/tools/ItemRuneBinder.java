...
import com.huto.forces_of_reality.containers.RuneBinderItemHandler;
...
public class ItemRuneBinder extends Item {
	...
	public ItemRuneBinder setName() {
		setRegistryName(ForcesOfReality.MOD_ID, name);
		return this;
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		if (worldIn.isRemote) {
			if (!playerIn.isSneaking()) {
				ForcesOfReality.proxy.openBinderGui();
	...
	public void togglePickup(PlayerEntity playerEntity, ItemStack stack) {
		...
		if (playerEntity instanceof ServerPlayerEntity)
			...
			playerEntity.sendStatusMessage(new StringTextComponent(
					I18n.format(Pickup ? "forces_of_reality.autopickupenabled" : "forces_of_reality.autopickupdisabled")), true);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip,
		...
		if (pickupEnabled)
			tooltip.add(new StringTextComponent(I18n.format("forces_of_reality.autopickupenabled")));
		else
			tooltip.add(new StringTextComponent(I18n.format("forces_of_reality.autopickupdisabled")));
