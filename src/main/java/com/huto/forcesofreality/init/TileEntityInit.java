...
public class TileEntityInit {
	...
	public static final RegistryObject<BlockEntityType<TileEntityHasturPylon>> hastur_pylon = TILES.register(
			"hastur_pylon",
			() -> BlockEntityType.Builder.create(TileEntityHasturPylon::new, BlockInit.hastur_pylon.get()).build(null));
