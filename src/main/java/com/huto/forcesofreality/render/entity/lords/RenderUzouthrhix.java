...
public class RenderUzouthrhix extends MobRenderer<EntityUzouthrhix, ModelUzouthrhix> {
	...
	public RenderUzouthrhix(EntityRenderDispatcher renderManagerIn) {
	...
	// Growth Scaling
	@Override
	protected void preRenderCallback(EntityUzouthrhix entitylivingbaseIn, PoseStack matrixStackIn,
