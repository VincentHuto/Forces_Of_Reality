...
import com.huto.forcesofreality.models.entity.summons.ModelDreadRocket;
...
public class RenderDreadRocket extends EntityRenderer<EntityDreadRocket> {
	protected static final ResourceLocation TEXTURE = new ResourceLocation(ForcesOfReality.MOD_ID,
			"textures/entity/dread_rocket/model_dread_rocket_tracking.png");
	private final ModelDreadRocket leashKnotModel = new ModelDreadRocket();

	public RenderDreadRocket(EntityRendererManager renderManagerIn) {
