...
import com.huto.forcesofreality.model.entity.summon.ModelHasturSpawn;
...
public class RenderHasturSpawn extends MobRenderer<EntityHasturSpawn, ModelHasturSpawn> {
	...
	public RenderHasturSpawn(EntityRenderDispatcher renderManagerIn) {
	...
	// Growth Scaling
	@Override
	protected void preRenderCallback(EntityHasturSpawn entitylivingbaseIn, PoseStack matrixStackIn,
