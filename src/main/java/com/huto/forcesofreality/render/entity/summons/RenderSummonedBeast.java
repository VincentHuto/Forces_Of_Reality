...
public class RenderSummonedBeast extends MobRenderer<EntitySummonedBeast, ModelSummonedBeast> {
	...
	public RenderSummonedBeast(EntityRenderDispatcher renderManagerIn) {
	...
	// Growth Scaling
	@Override
	protected void preRenderCallback(EntitySummonedBeast entitylivingbaseIn, PoseStack matrixStackIn,
