...
import com.huto.forcesofreality.model.block.ModelFloatingSkull;
import com.huto.forcesofreality.model.block.ModelHorizontalBone;
...
public class RenderSacrificialPyre extends BlockEntityRenderer<TileEntitySacrificePyre> {
	...
	public RenderSacrificialPyre(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TileEntitySacrificePyre te, float partialTicks, PoseStack matrixStackIn,
		...
		for (int i = 0; i < te.clientDevo; i++) {
			...
			IVertexBuilder ivertexbuilder1 = irendertypebuffer$impl1.getBuffer(
					boneHoriz.getRenderType(new ResourceLocation(ForcesOfReality.MOD_ID + ":textures/entity/bone_wrap.png")));
