...
public class RenderIcoSphere extends BlockEntityRenderer<TileEntityIcoSphere> {
	...
	@Override
	public void render(TileEntityIcoSphere te, float partialTicks, PoseStack matrixStackIn,
