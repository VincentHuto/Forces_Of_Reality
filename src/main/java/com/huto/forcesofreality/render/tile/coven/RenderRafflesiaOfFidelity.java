...
public class RenderRafflesiaOfFidelity extends BlockEntityRenderer<TileEntityRafflesiaOfFidelity> {
	private final ModelDrumMagatama magatamas = new ModelDrumMagatama();

	public RenderRafflesiaOfFidelity(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityRafflesiaOfFidelity te, float partialTicks, PoseStack matrixStackIn,
