...
public class RenderOccularHeap extends BlockEntityRenderer<TileEntityOccularHeap> {

	private final ModelFloatingEye magatamas = new ModelFloatingEye();

	public RenderOccularHeap(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TileEntityOccularHeap te, float partialTicks, PoseStack matrixStackIn,
