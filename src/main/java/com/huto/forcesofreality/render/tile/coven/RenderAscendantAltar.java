...
import com.huto.forcesofreality.model.block.ModelFloatingCandle;
...
public class RenderAscendantAltar extends BlockEntityRenderer<TileEntityAscendantAltar> {
	private final ModelFloatingCandle black_candle = new ModelFloatingCandle();

	public RenderAscendantAltar(BlockEntityRenderDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@Override
	public void render(TileEntityAscendantAltar te, float partialTicks, PoseStack matrixStackIn,
