...
public class ModelSparkDirectorArmored extends HumanoidModel<LivingEntity> {

	public ModelSparkDirectorArmored() {
		super(1.0f, 0, 64, 64);
		...
		sparkJar.setTextureOffset(31, 48).addBox(-4.0F, -24.0F, -11.0F, 1.0F, 9.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(31, 48).addBox(5.0F, -24.0F, -11.0F, 1.0F, 9.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(25, 50).addBox(-3.0F, -23.0F, -11.0F, 8.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(27, 49).addBox(-3.0F, -17.0F, -11.0F, 8.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(31, 48).addBox(-2.0F, -21.0F, -11.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(31, 48).addBox(-1.0F, -22.0F, -11.0F, 4.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(18, 62).addBox(0.0F, -20.0F, -12.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(18, 62).addBox(-3.0F, -18.0F, -12.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(18, 62).addBox(-3.0F, -22.0F, -12.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(18, 62).addBox(4.0F, -18.0F, -12.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(18, 62).addBox(4.0F, -22.0F, -12.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(31, 48).addBox(3.0F, -21.0F, -11.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		sparkJar.setTextureOffset(31, 48).addBox(-1.0F, -18.0F, -11.0F, 4.0F, 1.0F, 1.0F, 0.0F, false);
