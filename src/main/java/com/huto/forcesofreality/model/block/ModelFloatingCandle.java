...
public class ModelFloatingCandle extends Model {
	private final ModelPart bb_main;
	private final List<ModelPart> candleParts;
	...
	public ModelFloatingCandle() {
		...
		bb_main.setTextureOffset(0, 10).addBox(-2.0F, -4.0F, 0.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);
		bb_main.setTextureOffset(0, 0).addBox(-1.5F, -5.0F, 0.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
