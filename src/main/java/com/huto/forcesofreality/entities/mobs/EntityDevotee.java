package com.huto.forcesofreality.entities.mobs;
...
public class EntityDevotee extends MonsterEntity {

	public EntityDevotee(EntityType<? extends EntityDevotee> type, World worldIn) {
		super(type, worldIn);
