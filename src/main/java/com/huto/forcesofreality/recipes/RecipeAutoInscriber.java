...
public class RecipeAutoInscriber implements IModRecipe {
	private final ResourceLocation id;
	private final ItemStack output;
	private final ImmutableList<Ingredient> inputs;
	private final float vibes;

	public RecipeAutoInscriber(ResourceLocation id, ItemStack output, float vibesIn, Ingredient... inputs) {
	...
	public static RecipeAutoInscriber read(PacketBuffer buf) {
		...
		return new RecipeAutoInscriber(id, output, vibes, inputs);
	}
