...
public class SlotAdornmentArmor extends Slot {

	private EquipmentSlotType slotType;
	private PlayerEntity playerEntity;

	public SlotAdornmentArmor(IInventory inventoryIn, int index, int xPosition, int yPosition, EquipmentSlotType slotType,
