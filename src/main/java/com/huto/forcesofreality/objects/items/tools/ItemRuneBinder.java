...
public class ItemRuneBinder extends Item {
	...
	public ItemRuneBinder(String name, Integer size, Rarity rarity) {
		super(new Item.Properties().maxStackSize(1).group(ForcesOfRealityItemGroup.instance));
		this.name = name;
		this.size = size;
		this.rarity = rarity;
	}
	...
	public void togglePickup(PlayerEntity playerEntity, ItemStack stack) {
		...
		if (playerEntity instanceof ServerPlayerEntity)
			...
			playerEntity.sendStatusMessage(new StringTextComponent(
					I18n.format(Pickup ? "forcesofreality.autopickupenabled" : "forcesofreality.autopickupdisabled")), true);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip,
		...
		if (pickupEnabled)
			tooltip.add(new StringTextComponent(I18n.format("forcesofreality.autopickupenabled")));
		else
			tooltip.add(new StringTextComponent(I18n.format("forcesofreality.autopickupdisabled")));
