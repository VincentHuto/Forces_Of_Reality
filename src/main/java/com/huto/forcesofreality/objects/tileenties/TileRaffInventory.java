...
public abstract class TileRaffInventory extends TileMod {

	public TileRaffInventory(TileEntityType<?> tileEntityTypeIn) {
	...
	public static class SimpleItemStackHandler extends ItemStackHandler {
		...
		private final TileRaffInventory tile;

		public SimpleItemStackHandler(TileRaffInventory inv, boolean allowWrite) {
