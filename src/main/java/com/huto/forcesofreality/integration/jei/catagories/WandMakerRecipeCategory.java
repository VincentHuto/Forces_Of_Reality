...
import com.huto.forcesofreality.recipes.RecipeWandMaker;
...
public class WandMakerRecipeCategory implements IRecipeCategory<RecipeWandMaker> {
	...
	public WandMakerRecipeCategory(IGuiHelper guiHelper) {
		...
		overlay = guiHelper.createDrawable(new ResourceLocation("forcesofreality", "textures/gui/wand_maker_overlay.png"), 0,
				0, 150, 110);
