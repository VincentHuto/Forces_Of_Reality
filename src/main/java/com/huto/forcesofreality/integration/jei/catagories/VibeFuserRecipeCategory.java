...
import com.huto.forcesofreality.recipes.RecipeFuser;
...
public class VibeFuserRecipeCategory implements IRecipeCategory<RecipeFuser> {
	...
	public VibeFuserRecipeCategory(IGuiHelper guiHelper) {
		...
		overlay = guiHelper.createDrawable(new ResourceLocation("forcesofreality", "textures/gui/fuseroverlay.png"), 0, 0, 150,
				110);
