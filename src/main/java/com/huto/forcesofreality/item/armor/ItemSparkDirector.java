...
import com.huto.forcesofreality.model.armor.ModelSparkDirector;
import com.huto.forcesofreality.model.armor.ModelSparkDirectorArmored;
...
public class ItemSparkDirector extends ArmorItem {
	...
	public ItemSparkDirector(ArmorMaterial materialIn, EquipmentSlot slot, Properties builderIn,
			boolean isArmoredIn) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip,
		...
		if (pickupEnabled)
			tooltip.add(new StringTextComponent(I18n.format("forcesofreality.flightmodeenabled")));
		else
			tooltip.add(new StringTextComponent(I18n.format("forcesofreality.flightmodedisabled")));
