...
public final class ItemHelper {
	...
	public static InteractionResultHolder<ItemStack> actionResultFromType(InteractionResult type, ItemStack stack) {
		switch (type) {
		case SUCCESS:
			return InteractionResultHolder.resultSuccess(stack);
		case CONSUME:
	...
	/**
	 * Copies the nbt compound similar to how {@link CompoundNBT#copy()} does,
	 ...
	 *
	 * @implNote If the input {@link CompoundNBT} only contains the key we want to
	 *           skip, we return null instead of an empty {@link CompoundNBT}.
	 */
	@Nullable
