...
public class GuiRuneBinder extends ContainerScreen<ContainerRuneBinder> {
	public GuiRuneBinder(ContainerRuneBinder container, PlayerInventory playerInventory, ITextComponent name) {
		...
		case 18:
			GUI = new ResourceLocation(ForcesOfReality.MOD_ID, "textures/gui/rune_binder.png");
			xSize = 176;
			ySize = 150;
			break;
		case 27:
			GUI = new ResourceLocation(ForcesOfReality.MOD_ID, "textures/gui/rune_binder_upgrade.png");
			xSize = 176;
			ySize = 168;
			break;
		default:
			GUI = new ResourceLocation(ForcesOfReality.MOD_ID, "textures/gui/epic_gui.png");
			xSize = 212;
			ySize = 276;
			break;
		}
