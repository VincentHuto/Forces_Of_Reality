...
public class CovenPageLib {
	...
	public static List<GuiCovenPage> CombinationPageList = new ArrayList<GuiCovenPage>();
	...
	public static void registerPages() {
		...
		CombinationPageList.add(0, TOCPageList.get(6));
	...
	public static List<GuiCovenPage> getCombinationPageList() {
		return CombinationPageList;
	}
