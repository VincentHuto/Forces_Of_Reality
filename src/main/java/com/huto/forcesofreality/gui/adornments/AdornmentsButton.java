...
@OnlyIn(Dist.CLIENT)
public class AdornmentsButton extends AbstractButton {
	...
	@SuppressWarnings("rawtypes")
	public AdornmentsButton(AbstractContainerScreen parentGui, int x, int y, int width, int height) {
		super(x + parentGui.getGuiLeft() - 35, parentGui.getGuiTop() + y, width, height, new TextComponent(""));
