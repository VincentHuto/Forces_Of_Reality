...
public class ModelDreadRocketTracking extends EntityModel<EntityDreadRocketDirected> {
	...
	public ModelDreadRocketTracking() {
		textureWidth = 16;
		textureHeight = 16;
	...
	@Override
	public void setRotationAngles(EntityDreadRocketDirected entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
