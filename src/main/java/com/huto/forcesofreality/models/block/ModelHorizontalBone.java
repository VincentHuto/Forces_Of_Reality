...
public class ModelHorizontalBone extends Model {
	private final ModelRenderer bone;
	private final List<ModelRenderer> skullParts;

	public ModelHorizontalBone() {
		super(RenderType::getEntitySolid);


		bone = new ModelRenderer(this);
		bone.setRotationPoint(0.0F, 24.0F, 0.0F);
		bone.setTextureOffset(0, 2).addBox(1.0F, -1.0F, -5.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		bone.setTextureOffset(0, 2).addBox(1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		bone.setTextureOffset(0, 2).addBox(-3.0F, -1.0F, -5.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		bone.setTextureOffset(0, 2).addBox(-3.0F, -1.0F, 3.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
		bone.setTextureOffset(0, 8).addBox(-1.0F, -1.0F, -4.0F, 2.0F, 1.0F, 8.0F, 0.0F, false);
