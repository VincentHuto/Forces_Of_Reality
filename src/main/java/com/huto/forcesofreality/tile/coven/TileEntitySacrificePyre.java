...
public class TileEntitySacrificePyre extends TileModDevotion implements TickableBlockEntity {
	public int ticks;
	...
	public void tick() {
		...
		Player playerentity = this.world.getClosestPlayer((double) this.pos.getX() + 0.5D,
