...
public class MuladharaaParticleData implements IParticleFactory<ColoredDynamicTypeData> {
    private final IAnimatedSprite spriteSet;
    public static final String NAME = "muladharaa";

    public static final Random random = new Random();
    public MuladharaaParticleData(IAnimatedSprite sprite) {
    ...
    public static IParticleData createData(ParticleColor color) {
        return new ColoredDynamicTypeData(ParticleInit.muladharaa.get(), color,.25f,  36);
    }

    public static IParticleData createData(ParticleColor color, float scale, int age) {
        return new ColoredDynamicTypeData(ParticleInit.muladharaa.get(), color, scale, age);
    }
