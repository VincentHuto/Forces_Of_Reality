...
public class EntityFirstBeastBolt extends AbstractArrow {
	private static final EntityDataAccessor<Integer> COLOR = SynchedEntityData.createKey(EntityFirstBeastBolt.class,
			DataSerializers.VARINT);
	private Potion potion = Potions.EMPTY;
	private final Set<EffectInstance> customPotionEffects = Sets.newHashSet();
	private boolean fixedColor;

	public EntityFirstBeastBolt(EntityType<? extends EntityFirstBeastBolt> type, World worldIn) {
		super(type, worldIn);
	}
