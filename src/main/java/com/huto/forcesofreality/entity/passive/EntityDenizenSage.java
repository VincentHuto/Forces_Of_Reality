...
public class EntityDenizenSage extends Animal {
	private static final EntityDataAccessor<Integer> DENIZEN_TYPE = SynchedEntityData.createKey(EntityDenizenSage.class,
	...
	@Override
	public EntityDenizenSage createChild(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
