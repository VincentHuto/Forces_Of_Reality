package com.huto.forcesofreality.entity.passive;
...
public class EntityDenizen extends Animal {
	private static final EntityDataAccessor<Integer> DENIZEN_TYPE = SynchedEntityData.createKey(EntityDenizen.class,
	...
	@Override
	public EntityDenizen createChild(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
