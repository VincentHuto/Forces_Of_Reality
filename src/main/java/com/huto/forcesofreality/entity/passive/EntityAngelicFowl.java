...
public class EntityAngelicFowl extends AnimalEntity {
	...
	public EntityAngelicFowl(EntityType<? extends EntityAngelicFowl> type, World worldIn) {
		super(type, worldIn);
	...
	@Override
	public EntityAngelicFowl createChild(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
