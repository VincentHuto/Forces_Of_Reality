...
public class EntitySlug extends Animal {
	...
	private static final EntityDataAccessor<Integer> SLUG_TYPE = SynchedEntityData.createKey(EntitySlug.class,
	...
	public ActionResultType applyPlayerInteraction(PlayerEntity player, Vector3d vec, Hand hand) {
		...
		if (itemstack.getItem() == Items.BUCKET && !this.isChild()) {
			...
			ItemStack itemstack1 = DrinkHelper.fill(itemstack, player, ItemInit.bucket_slug.get().getDefaultInstance());
	...
	@Override
	public EntitySlug createChild(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
