	...
	public static Predicate<Entity> VORPAL = new Predicate<Entity>() {
		...
		public boolean test(Entity e) {
			if (e instanceof Raider || e instanceof Zombie || e instanceof Skeleton
					...
					|| e instanceof Creeper || e instanceof EntityBeastFromBeyond
					|| e instanceof EntitySummonedBeast || e instanceof EntityDerangedBeast || e instanceof Wolf
	...
	public static Predicate<Entity> COLDBLOODED = new Predicate<Entity>() {
		...
		public boolean test(Entity e) {
			if (e instanceof Raider || e instanceof Zombie || e instanceof WaterAnimal
					|| e instanceof SnowGolem || e instanceof Slime) {
				return true;
			} else {
				return false;
			}
