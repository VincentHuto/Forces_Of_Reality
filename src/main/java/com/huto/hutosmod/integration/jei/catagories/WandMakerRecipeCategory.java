...
public class WandMakerRecipeCategory implements IRecipeCategory<RecipeWandMaker> {
	...
	public static final ResourceLocation UID = new ResourceLocation(HutosMod.MOD_ID, "wand_maker");
	...
	public WandMakerRecipeCategory(IGuiHelper guiHelper) {
		...
		overlay = guiHelper.createDrawable(new ResourceLocation("hutosmod", "textures/gui/wand_maker_overlay.png"), 0,
				0, 150, 110);
