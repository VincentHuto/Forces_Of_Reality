	...
	public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>>
		...
		public CopyRuneBinderDataRecipe read(ResourceLocation recipeId, JsonObject json) {
			try {
				...
				HutosMod.LOGGER.info("Error reading CopyRuneBinder Recipe from packet: ", exception);
				throw exception;
			}
		}
		...
		public void write(PacketBuffer buffer, CopyRuneBinderDataRecipe recipe) {
			try {
				...
				HutosMod.LOGGER.info("Error writing CopyRuneBinder Recipe to packet: ", exception);
				throw exception;
			}
		}
	}
