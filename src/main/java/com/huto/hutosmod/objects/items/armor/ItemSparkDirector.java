...
public class ItemSparkDirector extends ArmorItem {
		...
		if (playerEntity instanceof ServerPlayerEntity) {
			...
			playerEntity.sendStatusMessage(
					new StringTextComponent(
							I18n.format(flightMode ? "hutosmod.autopickupenabled" : "hutosmod.autopickupdisabled")),
					true);
		}
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip,
		...
		if (pickupEnabled)
			tooltip.add(new StringTextComponent(I18n.format("hutosmod.flightmodeenabled")));
		else
			tooltip.add(new StringTextComponent(I18n.format("hutosmod.flightmodedisabled")));
