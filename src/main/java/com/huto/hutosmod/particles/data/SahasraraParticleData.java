...
public class SahasraraParticleData implements IParticleFactory<ColoredDynamicTypeData> {
    private final IAnimatedSprite spriteSet;
    public static final String NAME = "sahasrara";

    public static final Random random = new Random();
    public SahasraraParticleData(IAnimatedSprite sprite) {
    ...
    public static IParticleData createData(ParticleColor color) {
        return new ColoredDynamicTypeData(ParticleInit.sahasrara.get(), color,.25f,  36);
    }

    public static IParticleData createData(ParticleColor color, float scale, int age) {
        return new ColoredDynamicTypeData(ParticleInit.sahasrara.get(), color, scale, age);
    }
