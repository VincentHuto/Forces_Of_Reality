...
public class LayerAutomatonWindow extends LayerRenderer<EntityMalformedAutomaton, ModelMalformedAutomaton> {
	...
	public static final ResourceLocation GLASSBREAK1 = new ResourceLocation(HutosMod.MOD_ID,
			"textures/blocks/machine_glass_break_1.png");
	public static final ResourceLocation GLASSBREAK2 = new ResourceLocation(HutosMod.MOD_ID,
