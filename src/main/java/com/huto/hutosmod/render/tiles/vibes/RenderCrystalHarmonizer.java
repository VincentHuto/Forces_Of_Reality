...
public class RenderCrystalHarmonizer extends TileEntityRenderer<TileEntityCrystalHarmonizer> {
	private final ModelDrumMagatama magatamas = new ModelDrumMagatama();

	public RenderCrystalHarmonizer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileEntityCrystalHarmonizer te, float partialTicks, MatrixStack matrixStackIn,
