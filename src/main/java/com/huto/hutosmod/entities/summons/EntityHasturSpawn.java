package com.huto.hutosmod.entities.summons;
...
public class EntityHasturSpawn extends FlyingEntity implements IMob {
	...
	public static final Map<Integer, ResourceLocation> TEXTURE_BY_ID = Util.make(Maps.newHashMap(), (p_213410_0_) -> {
		p_213410_0_.put(0,
				new ResourceLocation(HutosMod.MOD_ID, "textures/entity/hastur_spawn/model_hastur_spawn_green.png"));
		p_213410_0_.put(1,
				new ResourceLocation(HutosMod.MOD_ID, "textures/entity/hastur_spawn/model_hastur_spawn_brown.png"));
		p_213410_0_.put(2,
				new ResourceLocation(HutosMod.MOD_ID, "textures/entity/hastur_spawn/model_hastur_spawn_grey.png"));
	});
