...
public class ItemRepulsionCharm extends Item {
	...
	public static void repel(Entity player, Level world, AABB effectBounds, double x, double y, double z) {
	...
	public void inventoryTick(ItemStack stack, Level worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		...
		if (stack.getOrCreateTag().getBoolean(TAG_STATE)) {
			...
			repel(entityIn, worldIn, new AABB(entityIn.position().add(-4, -4, -4), entityIn.position().add(4, 4, 4)),
