...
import com.vincenthuto.forcesofreality.registry.RenderTypeInit;
...
public class RenderMechanLaser {
	...
	private static void drawLasers(RenderLevelStageEvent  event, Vec3 from, HitResult trace, double xOffset,
		...
		if (player.getMainHandItem().getItem() instanceof ItemMechanGlove) {
			...
			if (stack.getItem() == ItemInit.mechan_module_laser.get() && player.isUsingItem()) {
