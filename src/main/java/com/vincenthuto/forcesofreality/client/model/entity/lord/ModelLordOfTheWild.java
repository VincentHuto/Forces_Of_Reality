...
import com.vincenthuto.forcesofreality.client.model.entity.mob.anim.LordOfTheWildAnimations;
...
public class ModelLordOfTheWild extends HierarchicalModel<EntityLordOfTheWild> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bLTibia = femur.addOrReplaceChild("bLTibia",
				...
				PartPose.offset(-0.5F, 2.1F, -6.4F));
		...
		PartDefinition bRTibia = bRHip.addOrReplaceChild("bRTibia",
				...
				PartPose.offset(-0.5F, 9.1F, 3.6F));
		...
		PartDefinition body = wholebody.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 66)
						...
						.addBox(-3.5F, -12.5F, 10.5F, 9.0F, 10.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(48, 44)
		...
		PartDefinition belly = body.addOrReplaceChild("belly",
				CubeListBuilder.create().texOffs(16, 181)
						.addBox(-7.5F, -0.5F, -2.3F, 3.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(46, 0)
						.addBox(-4.5F, -0.1F, 11.5F, 9.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(88, 0)
						.addBox(-4.5F, -0.5F, -0.5F, 9.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(22, 181)
						.addBox(4.5F, -0.5F, -2.3F, 3.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(62, 170)
						.addBox(-2.5F, -0.5F, -3.5F, 5.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 208)
						.addBox(-2.5F, 7.5F, -3.1F, 5.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(10, 219)
						.addBox(2.5F, 7.5F, -3.1F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(10, 220)
						.addBox(-3.5F, 7.5F, -3.1F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(52, 208)
						.addBox(-4.5F, -0.5F, -3.1F, 2.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(56, 208)
						.addBox(2.5F, -0.5F, -3.1F, 2.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 125)
						.addBox(-4.5F, -0.5F, -2.5F, 9.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 170)
						.addBox(-4.5F, 11.5F, -2.3F, 9.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(70, 216)
						.addBox(4.5F, 11.5F, -2.3F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(66, 216)
						.addBox(-6.5F, 11.5F, -2.3F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.0F, -12.0F, -13.0F));
