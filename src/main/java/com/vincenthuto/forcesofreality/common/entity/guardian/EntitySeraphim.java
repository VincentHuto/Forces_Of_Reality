...
public class EntitySeraphim extends Monster implements IEntityAdditionalSpawnData {
	...
	public EntitySeraphim(EntityType<? extends EntitySeraphim> type, Level worldIn) {
		super(type, worldIn);
	...
	public void tick() {
		...
		if (this.deathTicks <= 0) {
			...
			if (attackRoll % 100 * diffMult == 0) {
				...
				this.spawnMissileVortex(random.nextInt(15));
