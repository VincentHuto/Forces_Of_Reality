package com.vincenthuto.forcesofreality.common.entity.passive;
...
public class EntityDenizen extends Animal {
	private static final EntityDataAccessor<Integer> DENIZEN_TYPE = SynchedEntityData.defineId(EntityDenizen.class,
			EntityDataSerializers.INT);
	public static final Map<Integer, ResourceLocation> TEXTURE_BY_ID = Util.make(Maps.newHashMap(), (p_213410_0_) -> {
		p_213410_0_.put(0,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_grey.png"));
		p_213410_0_.put(1,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_grey_cloak.png"));
		p_213410_0_.put(2,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_red.png"));
		p_213410_0_.put(3,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_red_cloak.png"));
		p_213410_0_.put(4,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_white.png"));
		p_213410_0_.put(5,
				new ResourceLocation(ForcesOfReality.MOD_ID, "textures/entity/denizen/model_denizen_white_cloak.png"));
	});
	...
	public EntityDenizen(EntityType<? extends EntityDenizen> type, Level worldIn) {
		super(type, worldIn);
	...
	@Override
	public EntityDenizen getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
