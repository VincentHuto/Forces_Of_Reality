...
public class BeastHeldItemLayer<T extends LivingEntity, M extends EntityModel<T> & ArmedModel>
	...
	public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, T entitylivingbaseIn,
		...
		if (!itemstack.isEmpty() || !itemstack1.isEmpty()) {
			...
			this.renderArmWithItem(entitylivingbaseIn, itemstack1, ItemTransforms.TransformType.THIRD_PERSON_RIGHT_HAND,
					HumanoidArm.RIGHT, matrixStackIn, bufferIn, packedLightIn);
			this.renderArmWithItem(entitylivingbaseIn, itemstack, ItemTransforms.TransformType.THIRD_PERSON_LEFT_HAND,
					HumanoidArm.LEFT, matrixStackIn, bufferIn, packedLightIn);
			matrixStackIn.popPose();
		}
	}

	private void renderArmWithItem(LivingEntity ent, ItemStack stack, ItemTransforms.TransformType p_229135_3_,
