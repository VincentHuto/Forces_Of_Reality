...
import com.vincenthuto.forcesofreality.common.item.ItemCovenTome;
import com.vincenthuto.forcesofreality.common.item.ItemDryingAgent;
import com.vincenthuto.forcesofreality.common.item.ItemSacrificial;
import com.vincenthuto.forcesofreality.common.item.ItemSlugBucket;
import com.vincenthuto.forcesofreality.common.item.ItemSoakingAgent;
import com.vincenthuto.forcesofreality.common.item.ItemStormingAgent;
import com.vincenthuto.forcesofreality.common.item.armor.EnumModArmorTiers;
import com.vincenthuto.forcesofreality.common.item.armor.ItemAuricArmor;
import com.vincenthuto.forcesofreality.common.item.armor.ItemBackWings;
import com.vincenthuto.forcesofreality.common.item.armor.ItemBeastlyArmor;
import com.vincenthuto.forcesofreality.common.item.armor.ItemEmpCharm;
import com.vincenthuto.forcesofreality.common.item.armor.ItemInfluenceSuppressor;
import com.vincenthuto.forcesofreality.common.item.armor.ItemSparkDirector;
import com.vincenthuto.forcesofreality.common.item.armor.ItemWrithingArmor;
import com.vincenthuto.forcesofreality.common.item.coven.ItemConcecratedAurum;
import com.vincenthuto.forcesofreality.common.item.coven.ItemNeuroticMechanism;
import com.vincenthuto.forcesofreality.common.item.coven.ItemTwistedFabric;
import com.vincenthuto.forcesofreality.common.item.coven.sign.ItemBeastBreath;
import com.vincenthuto.forcesofreality.common.item.coven.sign.ItemCrossedKeys;
import com.vincenthuto.forcesofreality.common.item.coven.sign.ItemIntegralCog;
import com.vincenthuto.forcesofreality.common.item.coven.sign.ItemWatchfulPendant;
import com.vincenthuto.forcesofreality.common.item.coven.sign.ItemYellowSign;
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemAllegianceIdentifier;
...
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemDemonFlute;
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemDestabilizationCharm;
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemDiscordantBell;
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemDivineFeather;
...
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemStarSlug;
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemTrickAxe;
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemVorpalSword;
import com.vincenthuto.forcesofreality.common.item.coven.tool.ItemYellowTome;
import com.vincenthuto.forcesofreality.common.item.tool.EnumModToolTiers;
import com.vincenthuto.forcesofreality.common.item.tool.ItemBowBlade;
import com.vincenthuto.forcesofreality.common.item.tool.ItemDestructOrb;
import com.vincenthuto.forcesofreality.common.item.tool.ItemDestructOrbContained;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemMechanModuleBase;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemMechanModuleBlade;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemMechanModuleLaser;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemMechanModuleRocket;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemMechanModuleSalvo;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemMechanModuleShortCircuit;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemMechanModuleThruster;
import com.vincenthuto.forcesofreality.common.item.tool.coven.module.ItemWickedModuleLaser;
...
//			() -> new ItemAdvCovenTome(new Item.Properties().stacksTo(1)));
	...
	// Spawn Eggs
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_hastur = SPAWNEGGS.register("spawn_egg_hastur",
			() -> new ForgeSpawnEggItem(EntityInit.hastur, 10862336, 0,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_hastur_vassal = SPAWNEGGS
			.register("spawn_egg_hastur_vassal", () -> new ForgeSpawnEggItem(EntityInit.hastur_vassal, 10862336, 0x0000FF,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_tentacle = SPAWNEGGS.register("spawn_egg_tentacle",
			() -> new ForgeSpawnEggItem(EntityInit.tentacle, 22073, 12371968,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_denizen = SPAWNEGGS.register("spawn_egg_denizen",
			() -> new ForgeSpawnEggItem(EntityInit.denizen, 8750204, 12037632,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_denizen_sage = SPAWNEGGS
			.register("spawn_egg_denizen_sage", () -> new ForgeSpawnEggItem(EntityInit.denizen_sage, 8750204, 72037632,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_hastur_spawn = SPAWNEGGS
			.register("spawn_egg_hastur_spawn", () -> new ForgeSpawnEggItem(EntityInit.hastur_spawn, 4539136, 13548032,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_slug = SPAWNEGGS.register("spawn_egg_slug",
			() -> new ForgeSpawnEggItem(EntityInit.slug, 7761777, 4206080,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_seraphim = SPAWNEGGS.register("spawn_egg_seraphim",
			() -> new ForgeSpawnEggItem(EntityInit.seraphim, 16515071, 16514816,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_tetra = SPAWNEGGS.register("spawn_egg_tetra",
			() -> new ForgeSpawnEggItem(EntityInit.tetra, 14565021, 16464878,
					new Item.Properties()));
//	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_throne = SPAWNEGGS.register("spawn_egg_throne",
//			() -> new ForgeSpawnEggItem(EntityInit.throne, 16777215, 12745984,
//					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_beast_from_beyond = SPAWNEGGS
			.register("spawn_egg_beast_from_beyond", () -> new ForgeSpawnEggItem(EntityInit.beast_from_beyond, 9450752, 0,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_lord_of_the_wild = SPAWNEGGS.register(
			"spawn_egg_lord_of_the_wild", () -> new ForgeSpawnEggItem(EntityInit.lord_of_the_wild, 9450752, 7450752,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_summoned_beast = SPAWNEGGS
			.register("spawn_egg_summoned_beast", () -> new ForgeSpawnEggItem(EntityInit.summoned_beast, 8155760, 9450752,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_malformed_automaton = SPAWNEGGS.register(
			"spawn_egg_malformed_automaton", () -> new ForgeSpawnEggItem(EntityInit.malformed_automaton, 15576576, 41873,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_dark_young = SPAWNEGGS
			.register("spawn_egg_dark_young", () -> new ForgeSpawnEggItem(EntityInit.dark_young, 0, 0xFA00FF,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_tulpa = SPAWNEGGS.register("spawn_egg_tulpa",
			() -> new ForgeSpawnEggItem(EntityInit.tulpa, 0, 0,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_scuttling_occulus = SPAWNEGGS.register(
			"spawn_egg_scuttling_occulus", () -> new ForgeSpawnEggItem(EntityInit.scuttling_occulus, 12764357, 5767365,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_dread_bot = SPAWNEGGS.register("spawn_egg_dread_bot",
			() -> new ForgeSpawnEggItem(EntityInit.dread_bot, 12743680, 12764357,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_mechan = SPAWNEGGS.register("spawn_egg_mechan",
			() -> new ForgeSpawnEggItem(EntityInit.mechan, 12743680, 0,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_veritas = SPAWNEGGS.register("spawn_egg_veritas",
			() -> new ForgeSpawnEggItem(EntityInit.veritas, 0xFFFFFF, 0xFFFFFF,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_black_goat = SPAWNEGGS
			.register("spawn_egg_black_goat", () -> new ForgeSpawnEggItem(EntityInit.black_goat, 0xF23FaF, 0xF23FaF,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_angelic_fowl = SPAWNEGGS
			.register("spawn_egg_angelic_fowl", () -> new ForgeSpawnEggItem(EntityInit.angelic_fowl, 0xBDFFE2, 0xFFD25B,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_deranged_beast = SPAWNEGGS
			.register("spawn_egg_deranged_beast", () -> new ForgeSpawnEggItem(EntityInit.deranged_beast, 4603962, 5252864,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_uzouthrhix = SPAWNEGGS
			.register("spawn_egg_uzouthrhix", () -> new ForgeSpawnEggItem(EntityInit.uzouthrhix, 23862, 8133430,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_xanthous_king = SPAWNEGGS
			.register("spawn_egg_xanthous_king", () -> new ForgeSpawnEggItem(EntityInit.xanthous_king, 10862336, 852039,
					new Item.Properties()));
	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_devotee = SPAWNEGGS.register("spawn_egg_devotee",
			() -> new ForgeSpawnEggItem(EntityInit.devotee, 4341573, 9604677,
					new Item.Properties()));

	public static final RegistryObject<ForgeSpawnEggItem> spawn_egg_first_beast = SPAWNEGGS
			.register("spawn_egg_first_beast", () -> new ForgeSpawnEggItem(EntityInit.the_first_beast, 6499072, 11777460,
					new Item.Properties()));
