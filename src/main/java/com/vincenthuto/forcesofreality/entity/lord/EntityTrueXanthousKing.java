...
public class EntityTrueXanthousKing extends Monster implements IEntityAdditionalSpawnData/* , IAnimatable */ {
...
//	public static final Animation BITE_ANIMATION = new Animation(17);
	...
	public EntityTrueXanthousKing(EntityType<? extends EntityTrueXanthousKing> type, Level worldIn) {
		super(type, worldIn);
