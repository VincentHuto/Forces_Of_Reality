...
public class EntityBeastFromBeyond extends Monster implements IEntityAdditionalSpawnData {
	...
	public EntityBeastFromBeyond(EntityType<? extends EntityBeastFromBeyond> type, Level worldIn) {
		super(type, worldIn);
	...
	protected void tickDeath() {
		...
		if (this.deathTicks >= 100 && this.deathTicks <= 200) {
			...
			if (this.deathTicks >= 100) {
				this.level.addParticle(ParticleTypes.FALLING_LAVA, this.getX() + f, this.getY() + 2.0D + f1,
						this.getZ() + f2, 0.0D, 0.0D, 0.0D);
			}
