...
public class EntityMalformedAutomaton extends Monster implements IEntityAdditionalSpawnData {
	...
	protected static final EntityDataAccessor<Byte> PLAYER_CREATED = SynchedEntityData
			.defineId(EntityMalformedAutomaton.class, EntityDataSerializers.BYTE);
	...
	public EntityMalformedAutomaton(EntityType<? extends EntityMalformedAutomaton> type, Level worldIn) {
		super(type, worldIn);
