...
public class ItemInit {
	...
	public static final RegistryObject<Item> allegiance_identifier = ITEMS.register("allegiance_identifier",
			() -> new ItemAllegianceIdentifier(
					new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1)));
...
//			() -> new ItemAdvCovenTome(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1)));
	...
	public static final RegistryObject<Item> unsettling_fabric = ITEMS.register("unsettling_fabric",
			() -> new ItemSacrificial(new Item.Properties().tab(ForcesOfRealityItemGroup.instance),
	...
	public static final RegistryObject<Item> crossed_keys = ITEMS.register("crossed_keys",
			() -> new ItemCrossedKeys(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1),
	...
	public static final RegistryObject<Item> star_slug = ITEMS.register("star_slug", () -> new ItemStarSlug(
			new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> everwatchful_pendant = ITEMS.register("everwatchful_pendant",
			() -> new ItemWatchfulPendant(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1),
	...
	public static final RegistryObject<Item> breath_of_the_beast = ITEMS.register("breath_of_the_beast",
			() -> new ItemBeastBreath(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1),
					EnumCovenants.BEAST, 10));
	public static final RegistryObject<Item> blooddrawn_fang = ITEMS.register("blooddrawn_fang",
			() -> new ItemSacrificial(new Item.Properties().tab(ForcesOfRealityItemGroup.instance), EnumCovenants.BEAST,
					1));
	...
	public static final RegistryObject<Item> first_beast_bolt = ITEMS.register("first_beast_bolt",
			() -> new ItemBeastBolt(new Item.Properties().tab(ForcesOfRealityItemGroup.instance)));

	// Machine
	public static final RegistryObject<Item> integral_cog = ITEMS.register("integral_cog",
			() -> new ItemIntegralCog(
					new Item.Properties().tab(ForcesOfRealityItemGroup.instance).rarity(HLTextUtils.AURIC).stacksTo(1),
	...
	public static final RegistryObject<Item> auric_ingot = ITEMS.register("auric_ingot",
			() -> new Item(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).rarity(HLTextUtils.AURIC)));
	...
	public static final RegistryObject<Item> machina_cage = ITEMS.register("machina_cage",
			() -> new ItemMachinaCage(new Item.Properties().tab(ForcesOfRealityItemGroup.instance)));
	...
	public static final RegistryObject<Item> mechan_glove = MODELEDITEMS.register("mechan_glove",
			() -> new ItemMechanGlove(new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1)
					.tab(ForcesOfRealityItemGroup.instance).durability(512), "mechan_glove", 3, 5, 1));
	public static final RegistryObject<Item> mechan_glove_superior = MODELEDITEMS
			.register("mechan_glove_superior",
					() -> new ItemMechanGlove(new Item.Properties().rarity(Rarity.RARE).stacksTo(1)
							.tab(ForcesOfRealityItemGroup.instance).durability(1024), "mechan_glove_superior", 6, 10,
							2));
	public static final RegistryObject<Item> mechan_glove_masterpiece = MODELEDITEMS
			.register("mechan_glove_masterpiece",
					() -> new ItemMechanGlove(new Item.Properties().rarity(Rarity.EPIC).stacksTo(1)
							.tab(ForcesOfRealityItemGroup.instance).durability(2048), "mechan_glove_masterpiece", 9, 15,
							3));
			...
			.register("mechan_glove_godlike",
					() -> new ItemMechanGlove(
							new Item.Properties().rarity(HLTextUtils.AURIC).stacksTo(1)
									.tab(ForcesOfRealityItemGroup.instance).durability(4096),
							"mechan_glove_godlike", 9, 35, 4));

	// Modules
	public static final RegistryObject<Item> mechan_module = ITEMS.register("mechan_module",
			() -> new ItemMechanModuleBase(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1), 0,
					"Base Module"));
	public static final RegistryObject<Item> mechan_module_rocket = ITEMS.register("mechan_module_rocket",
			() -> new ItemMechanModuleRocket(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1),
	...
	public static final RegistryObject<Item> mechan_module_salvo = ITEMS.register("mechan_module_salvo",
			() -> new ItemMechanModuleSalvo(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1), 2,
	...
	public static final RegistryObject<Item> mechan_module_shortcircuit = ITEMS.register("mechan_module_shortcircuit",
			() -> new ItemMechanModuleShortCircuit(
					new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1), 3,
	...
	public static final RegistryObject<Item> mechan_module_laser = ITEMS.register("mechan_module_laser",
			() -> new ItemMechanModuleLaser(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1), 2,
	...
	public static final RegistryObject<Item> mechan_module_blade = ITEMS.register("mechan_module_blade",
			() -> new ItemMechanModuleBlade(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1), 1,
	...
	public static final RegistryObject<Item> mechan_module_thruster = ITEMS.register("mechan_module_thruster",
			() -> new ItemMechanModuleThruster(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1),
	 ...
	 * Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1).
	...
	public static final RegistryObject<Item> auric_bow_blade = ADVITEMS.register("auric_bow_blade",
			() -> new ItemBowBlade(
					new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1).durability(2048), 3, 10,
					1));
	/*
	...
	public static final RegistryObject<Item> auric_trick_axe = ADVITEMS.register("auric_trick_axe",
			() -> new ItemTrickAxe(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1),
					EnumModToolTiers.AURIC));
	// Ascendant + Machine
	public static final RegistryObject<Item> concecrated_aurum = ITEMS.register("concecrated_aurum",
			() -> new ItemConcecratedAurum(new Item.Properties().tab(ForcesOfRealityItemGroup.instance)));
	...
	public static final RegistryObject<Item> wicked_module_laser = ITEMS.register("wicked_module_laser",
			() -> new ItemWickedModuleLaser(
					new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1).rarity(Rarity.EPIC), 4,
	...
	public static final RegistryObject<Item> twisted_fabric = ITEMS.register("twisted_fabric",
			() -> new ItemTwistedFabric(new Item.Properties().tab(ForcesOfRealityItemGroup.instance)));

	// Eldritch+Beast+Hastur
	public static final RegistryObject<Item> destruction_orb = ITEMS.register("destruction_orb",
			() -> new ItemDestructOrb(new Item.Properties().tab(ForcesOfRealityItemGroup.instance).stacksTo(1)));
	...
	public static final RegistryObject<Item> writhing_boots = ITEMS.register("writhing_boots",
			() -> new ArmorItem(EnumModArmorTiers.WRITHING, EquipmentSlot.FEET,
					(new Item.Properties()).tab(ForcesOfRealityItemGroup.instance)));
...
//					new Item.Properties().tab(Itemtab.MISC).tab(ForcesOfRealityItemGroup.instance)));
...
//					7450752, new Item.Properties().tab(Itemtab.MISC).tab(ForcesOfRealityItemGroup.instance)));
...
//					15576576, 41873, new Item.Properties().tab(Itemtab.MISC).tab(ForcesOfRealityItemGroup.instance)));
...
//					5767365, new Item.Properties().tab(Itemtab.MISC).tab(ForcesOfRealityItemGroup.instance)));
