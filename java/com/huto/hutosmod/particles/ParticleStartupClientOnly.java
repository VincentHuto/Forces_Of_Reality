...
public class ParticleStartupClientOnly
{
  /**
  ...
  public static void onParticleFactoryRegistration(ParticleFactoryRegisterEvent event) {
    ...
    Minecraft.getInstance().particles.registerFactory(ParticleStartupServerOnly.flameParticleType, sprite -> new FlameParticleFactory(sprite));
