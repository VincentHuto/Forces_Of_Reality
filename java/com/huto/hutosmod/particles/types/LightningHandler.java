...
@Mod.EventBusSubscriber(value = Dist.CLIENT, modid = HutosMod.MOD_ID)
public class LightningHandler {
	...
	private static final ResourceLocation outsideResource = new ResourceLocation(
			HutosMod.MOD_ID + ":textures/misc/wisp_large.png");
	private static final ResourceLocation insideResource = new ResourceLocation(
			HutosMod.MOD_ID + ":textures/misc/wisp_small.png");
