...
public class RenderStorageDrum extends TileEntityRenderer<TileEntityStorageDrum> {
	...
	private void renderCube(TileEntityStorageDrum te, float offset, float fIn, Matrix4f matrix, IVertexBuilder vertx) {
		...
		float a = 0.8f;
		this.renderFace(te, matrix, vertx, 0.125F, .875F, 0.0625F, heightMod, .875F, .875F, .875F, .875F, r, g, b, a,
				Direction.SOUTH);
		this.renderFace(te, matrix, vertx, 0.125F, .875F, heightMod, 0.00F, 0.125F, 0.125F, 0.125F, 0.125F, r, g, b, a,
				Direction.NORTH);
		this.renderFace(te, matrix, vertx, 0.875F, 0.875F, heightMod, 0.0625F, 0.125F, 0.875F, 0.875F, 0.125F, r, g, b,
				a, Direction.EAST);
		this.renderFace(te, matrix, vertx, 0.125F, 0.125F, 0.00F, heightMod, 0.125F, 0.875F, 0.875F, 0.125F, r, g, b, a,
				Direction.WEST);
		...
		this.renderFace(te, matrix, vertx, 0.125F, 0.875F, heightMod, heightMod, 0.875F, 0.875F, 0.125F, 0.125F, r, g,
				b, a, Direction.UP);
	}
