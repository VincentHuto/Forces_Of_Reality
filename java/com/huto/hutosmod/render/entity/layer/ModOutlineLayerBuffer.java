...
@OnlyIn(Dist.CLIENT)
public class ModOutlineLayerBuffer implements IRenderTypeBuffer {
   ...
   public ModOutlineLayerBuffer(IRenderTypeBuffer.Impl bufferIn) {
   ...
   public IVertexBuilder getBuffer(RenderType p_getBuffer_1_) {
      if (p_getBuffer_1_.isColoredOutlineBuffer()) {
         ...
         return new ModOutlineLayerBuffer.ColoredOutline(ivertexbuilder2, this.red, this.green, this.blue, this.alpha);
      } else {
         ...
         if (optional.isPresent()) {
            ...
            ModOutlineLayerBuffer.ColoredOutline outlinelayerbuffer$coloredoutline = new ModOutlineLayerBuffer.ColoredOutline(ivertexbuilder1, this.red, this.green, this.blue, this.alpha);
