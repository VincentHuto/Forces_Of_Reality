...
public class GuiVirtuousEnchanter extends ContainerScreen<ContainerVirtuousEnchanter> {
	private static final ResourceLocation ENCHANTMENT_TABLE_BOOK_TEXTURE = new ResourceLocation(HutosMod.MOD_ID,
			"textures/entity/virtuous_table_book.png");
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(HutosMod.MOD_ID,
