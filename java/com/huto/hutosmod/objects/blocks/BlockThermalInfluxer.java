...
public class BlockThermalInfluxer extends Block {
	...
	private static final VoxelShape SHAPE_N = Stream
			.of(Block.makeCuboidShape(0, 8, 0, 16, 9, 16), Block.makeCuboidShape(3, 9, 3, 13, 14, 13),
					Block.makeCuboidShape(0, 9, 0, 3, 13, 3), Block.makeCuboidShape(2, -2, 2, 5, 8, 5),
					Block.makeCuboidShape(13, 9, 0, 16, 13, 3), Block.makeCuboidShape(11, -2, 2, 14, 8, 5),
					Block.makeCuboidShape(13, 9, 13, 16, 13, 16), Block.makeCuboidShape(11, -2, 11, 14, 8, 14),
					Block.makeCuboidShape(0, 9, 13, 3, 13, 16), Block.makeCuboidShape(2, -2, 11, 5, 8, 14),
					...
					Block.makeCuboidShape(3, 3, 1, 6, 8, 4), Block.makeCuboidShape(12, 3, 3, 15, 8, 6),
					Block.makeCuboidShape(10, 3, 12, 13, 8, 15), Block.makeCuboidShape(1, 3, 10, 4, 8, 13))
			.reduce((v1, v2) -> {
