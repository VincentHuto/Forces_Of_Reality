...
public class ItemRunePatternMetamorphosisCW extends Item {

	public ItemRunePatternMetamorphosisCW(Properties prop) {
		super(prop);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (worldIn.isRemote) {
			Minecraft.getInstance().displayGuiScreen(
					new GuiRunePattern(new ItemStack(ItemInit.rune_metamorphosis_cw.get()), ModChiselRecipes.recipeMetamorphosisCW));
