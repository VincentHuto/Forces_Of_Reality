...
public class ItemRunePatternMilkWeedContract extends Item {

	public ItemRunePatternMilkWeedContract(Properties prop) {
		super(prop);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (worldIn.isRemote) {
			Minecraft.getInstance().displayGuiScreen(new GuiRunePattern(new ItemStack(ItemInit.rune_milkweed_c.get()),
