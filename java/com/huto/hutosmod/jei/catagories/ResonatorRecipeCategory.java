...
public class ResonatorRecipeCategory implements IRecipeCategory<RecipeResonator> {
	...
	public static final ResourceLocation UID = new ResourceLocation(HutosMod.MOD_ID, "vibe_resonator");
	...
	public ResonatorRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = I18n.format("hutosmod.jei.resonator");
	...
	public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull RecipeResonator recipe,
		...
		if (recipe.getRecipeType() == EnumEssecenceType.MANA) {
			...
			catalyst = BlockInit.display_glass.get();
